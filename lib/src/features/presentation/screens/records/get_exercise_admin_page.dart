...
class GetActivityAdminPage extends StatelessWidget{
  const GetActivityAdminPage({super.key});
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: _GetActivityAdminPage()
      );
  }
}


class _GetActivityAdminPage extends StatefulWidget{
  const _GetActivityAdminPage();

  @override
  State<_GetActivityAdminPage> createState() => _GetActivityAdminPageState();
}


class _GetActivityAdminPageState extends State<_GetActivityAdminPage>{
